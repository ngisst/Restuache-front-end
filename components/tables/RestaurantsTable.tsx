...
export default function RestaurantsTable() {
  ...
  const [restaurantIfno, setRestaurantInfo] = useState(null);
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="relative">
            ...
            {openFilter && (
              <div className="animate-in slide-in-from-top-4 absolute top-full left-1/2 z-10 mt-2 w-[250px] -translate-x-1/2 transform duration-700">

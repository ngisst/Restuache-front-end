...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen ">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32">
          <div className="text-center">
            <div className="mb-8 flex justify-center">
              <div className="rounded-full border border-orange-500/30 bg-orange-500/20 p-4 backdrop-blur-sm">
      ...
      {/* Mission Section */}
      <div className="bg-gradient-to-r from-slate-50 to-orange-50 py-20">
      ...
      {/* CTA Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-slate-800 to-orange-900 py-20">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Link
              href="/restaurants"
              className="transform rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 px-8 py-4 font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
            >
              Browse Restaurants
            </Link>
          </div>
